...
curl -X "POST" "http://21.84.62.78:8080/openapi/v1beta1/evaluate/react/chat" \
     -H 'Content-Type: application/json; charset=UTF-8' \
     -H 'Authorization: Bearer PzOTE1Rifb5y3HullaxpZfZ3uIRHNFZU' \
     -d $'{
  "agent_id": "lObicAsQp0lb",
  "messages": [
    {
      "role": "user",
      "content":  "今年高考人数多少"
...
curl -X "POST" "http://21.84.62.78:8080/openapi/v1beta1/admin/tool/list" \
     -H 'Content-Type: application/json; charset=UTF-8' \
     -H 'Authorization: Bearer PzOTE1Rifb5y3HullaxpZfZ3uIRHNFZU' \
     -d $'{
  "agent_id": "lObicAsQp0lb"
